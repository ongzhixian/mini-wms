...
{
    Task AddUserAsync(NewUserViewModel newUser);
    Task<LoginResponse> AuthenticateAsync(LoginViewModel login);
    Task<IEnumerable<UserRecord>> GetAllUsersAsync();
    Task<PagedData<UserRecord>> GetAllUsersAsync(PagedDataOptions pagedData);
}
...
public class UserService : IUserService
{
    ...
    public async Task<PagedData<UserRecord>> GetAllUsersAsync(PagedDataOptions pagedData)
    {
